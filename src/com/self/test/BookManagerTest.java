...
public class BookManagerTest {
	...
	public static void main(String[] args) {
		...
		allBooks.put(678, new Magazine(678, "인재경영", "젠슨스", "인싸이트코리아", 75000, new MyDate(2021, 7, 13), 5, 1.2));
		...
		for (Book b : allBooks.values()) {
		    try {
		        manager.estimatedReadTime(b.getIsbn()); 
		    } catch (BookNotFoundException | InvalidBookTypeException e) {
		        System.out.println("예외 발생: " + e.getMessage());
		    }
		}
	}
